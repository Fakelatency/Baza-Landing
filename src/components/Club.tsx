    ...
    <section className="bg-navy-950 text-white py-20 px-6 md:px-[6vw] border-b border-navy-300/15" id="klub">
      ...
      <div className="grid md:grid-cols-3 gap-6 md:gap-8">
        <div className="glass-card relative min-h-[420px] overflow-hidden group">
          <Image src="/images/baza-kawa.jpg" alt="Ekspres i kawa w Baza Padel Club" fill className="object-cover saturate-[0.88] group-hover:scale-105 transition-transform duration-700" />
